...
import { Layers, Zap, TrendingUp, Wrench } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: 'Scalable architecture design, technology stack selection, and system design.',
    },
    {
      icon: <Zap className="w-12 h-12 text-[#de362a]" />,
      title: 'MVP Development',
      description: 'Rapid prototyping and minimum viable product development to validate ideas.',
    },
    {
      icon: <TrendingUp className="w-12 h-12 text-[#de362a]" />,
      title: 'Feature Expansion',
      description: 'Adding new capabilities, integrations, and functionality to existing products.',
    },
    {
      icon: <TrendingUp className="w-12 h-12 text-[#de362a]" />,
      title: 'Product Scaling',
      description: 'Performance optimization, infrastructure scaling, and capacity planning.',
    },
    {
      icon: <Wrench className="w-12 h-12 text-[#de362a]" />,
      title: 'Technical Debt Management',
      description: 'Code refactoring, modernization, and continuous improvement.',
    },
  ];
