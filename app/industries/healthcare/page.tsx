...
import { Heart, AlertTriangle, CheckCircle, Wrench } from 'lucide-react';
...
export default function HealthcarePage() {
  ...
  const solutions = [
    ...
    'Cloud infrastructure with encryption',
  ];
    ...
    <div className="pt-20">
        ...
        <div className="max-w-[1240px] mx-auto px-6">
          ...
          >
            ...
            <motion.p variants={fadeInRight} className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto">
              Secure, compliant software solutions for healthcare organizations
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-[1240px] mx-auto px-6">
          <h2 className="text-4xl font-bold mb-8 flex items-center gap-4">
            <Heart className="w-10 h-10 text-[#de362a]" />
            Industry Overview
          </h2>
          <p className="text-lg text-gray-600 mb-8">
            Healthcare organizations require software solutions that prioritize patient safety, data security, and regulatory compliance. ASAL delivers HIPAA-compliant systems with robust security and seamless integration capabilities.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-[1240px] mx-auto px-6">
          ...
          <p className="text-lg text-gray-600 mb-8">
            HIPAA compliance, FDA regulations for medical devices, GDPR for patient data, and HL7/FHIR interoperability standards.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-[1240px] mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-8">
            Ready to Build Compliant Healthcare Solutions?
          </h2>
          <Link
            href="/contact"
